# Generated by Django 2.2.28 on 2022-06-23 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book', models.ForeignKey(null=True, on_delete=django.db.models.fields.NOT_PROVIDED, to='account.Book')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ManyToManyField(help_text='Select a genre for this book', to='account.Genre'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
